...
//El extends me ahorra reescribir toda la clase de nuevo, puedo heredar algunas propiedades de la clase padre
//Extendiendo nuna nueva clase desde PersonaHeroe
class Heroe extends PersonaHeroe{
    clan = 'sin clan';

    constructor(name, nickName, phrase){
        super(name, nickName, phrase);
        this.clan = 'Avengers';
    }

    quienSoy(){
        console.log(`Soy ${this.name}, de ${this.clan}`)
        super.whoAmI();
    }
}
